const Contact = {
                    ...
                    <div class="contact-me-form">
                        <form @submit.prevent="submitForm">
                            <div class="contact-name">
                                ...
                                <input v-model="name" class="input-name" type="text" placeholder="Your Name" />
                            </div>
                            ...
                            <div class="contact-name">
                                ...
                                <input v-model="email" class="input-mail" type="text" placeholder="Your Email"/>
                            </div>
                            ...
                            <div class="contact-msg">
                                ...
                                <textarea v-model="message" class="input-msg" type="text" placeholder="Your Message"></textarea>
                            </div>
    ...
    methods:{
        submitForm(){
            ...
            .then(() => {
                this.successMsg = "Your message sent successfully";
