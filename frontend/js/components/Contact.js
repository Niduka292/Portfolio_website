            ...
            <div class="contact-section-container">
                <div class="connect-with-me">
                    ...
                    <div class="connects-container">
                        <a class="connect-linkedin" href="https://linkedin.com/in/niduka-jayathunga" target="_blank"> 
                        ...
                        <a class="connect-insta" href="https://www.instagram.com/niduka_065_" target="_blank"> 
                            <div class="connect-with-me-component">
                        ...
                        <a class="connect-github" href="https://github.com/Niduka292" target="_blank"> 
                            <div class="connect-with-me-component">
                    ...
                    <div class="contact-me-form">
                        <form @submit.prevent="submitForm">
                            <div class="contact-name">
                                ...
                                <input v-model="name" class="input-name" type="text" placeholder="Your Name" required :disabled="isSubmitting" />
                            </div>
                            ...
                            <div class="contact-name">
                                ...
                                <input v-model="email" class="input-mail" type="email" placeholder="Your Email" required :disabled="isSubmitting"/>
                            </div>
                            ...
                            <div class="contact-msg">
                                ...
                                <textarea v-model="message" class="input-msg" type="text" placeholder="Your Message" required :disabled="isSubmitting"></textarea>
                            </div>
