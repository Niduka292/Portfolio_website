            ...
            <div class="contact-section-container">
                <div class="connect-with-me">
                    ...
                    <div class="connects-container">
                        <a class="connect-linkedin" href="https://linkedin.com/in/niduka-jayathunga" target="_blank" rel="noopener noreferrer">
                        ...
                        <a class="connect-insta" href="https://www.instagram.com/niduka_065_" target="_blank" rel="noopener noreferrer">
                            <div class="connect-with-me-component">
                                <img src="./assets/insta-animated.png" class="linkedin-icon"/>
                                <div class="connect-with-me-text">
                                    <p class="connect-component-line-1">Instagram</p>
                                    <p class="connect-component-line-2">@niduka_065_</p>
                                </div>
                            </div>
                        </a>

                        <a class="connect-github" href="https://github.com/Niduka292" target="_blank" rel="noopener noreferrer">
                            <div class="connect-with-me-component">
                                <img src="./assets/github-animated.png" class="linkedin-icon"/>
                                <div class="connect-with-me-text">
                                    <p class="connect-component-line-1">Github</p>
                                    <p class="connect-component-line-2">@Niduka292</p>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="contact-me-form">
                        <form @submit.prevent="submitForm">
                            <div class="contact-name">
                                ...
                                <input v-model="name" aria-label="Your Name" autocomplete="name" class="input-name" type="text" placeholder="Your Name" required :disabled="isSubmitting" />
                            </div>
                            ...
                            <div class="contact-name">
                                ...
                                <input v-model="email" aria-label="Your Email" autocomplete="email" class="input-mail" type="email" placeholder="Your Email" required :disabled="isSubmitting"/>
                            </div>
                            ...
                            <div class="contact-msg">
                                ...
                                <textarea v-model="message" aria-label="Your Message" class="input-msg" type="text" placeholder="Your Message" required :disabled="isSubmitting"></textarea>
                            </div>
                            <button type="submit" class="send-message" :disabled="isSubmitting">
